...
video_output = cv2.VideoWriter('output4.mp4',fourcc,fps,frame)
...
while cap.isOpened():
    ...
    ## Putting conditions on Torso Inclination
    ...
    ## Putting conditions on Neck Inclination
    ...
    cv2.circle(img,(right_ear_x,right_ear_y),5,(0,255,0),-1)
    cv2.circle(img,(right_shoulder_x,right_shoulder_y),5,(0,255,0),-1)


    # joining landmarks
    cv2.line(img,(right_shoulder_x,right_shoulder_y),(right_hip_x,right_hip_y),(0,255,255),4)

    cv2.line(img,(right_ear_x,right_ear_y),(right_shoulder_x,right_shoulder_y),(0,0,255),4)


    # displaying angle on hip

    cv2.putText(img,str(int(torso_inclination)),(right_hip_x,right_hip_y),cv2.FONT_HERSHEY_PLAIN,3,(255,255,255),2)
    cv2.putText(img,"Torso Inclination:"+str(int(torso_inclination)),(700,40),cv2.FONT_HERSHEY_PLAIN,3,(0,0,255),2)

    cv2.putText(img,str(int(neck_inclination)),(right_shoulder_x,right_shoulder_y),cv2.FONT_HERSHEY_PLAIN,3,(255,255,0),2)
    cv2.putText(img,"Neck Inclination:"+str(int(neck_inclination)),(700,80),cv2.FONT_HERSHEY_PLAIN,3,(255,0,255),2)
